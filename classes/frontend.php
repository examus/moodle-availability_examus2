...
class frontend extends \core_availability\frontend {
    ...
    protected function get_javascript_strings() {
        $strings = [
            ...
            'allow_to_use_books',
            'allow_to_use_paper',
            'allow_to_use_messengers',
            'allow_to_use_calculator',
            'allow_to_use_excel',
            'allow_to_use_human_assistant',
            'allow_absence_in_frame',
            'allow_voices',
            'allow_wrong_gaze_direction',
            'auto_rescheduling',
            'enable',
            'scheduling_required',
            'identification',
            'face_passport_identification',
            'face_identification',
            ...
            'select_groups',
            'select_groups_desc',
            'web_camera_main_view',
            'web_camera_main_view_front',
            'web_camera_main_view_side',
            'auxiliary_camera',
            'visible_warnings',
            'scoring_params_header',
            ...
            'biometry_theme',
            'duration_desc',
            'proctoring_mode_desc',
            'identification_desc',
            'scheduling_required_desc',
            'auto_rescheduling_desc',
            'is_trial_desc',
            'enable_ldb_desc', 
            'custom_rules_desc',
            'auxiliary_camera_desc',
            'auxiliary_camera_mode',
            'auxiliary_camera_mode_photo',
            'auxiliary_camera_mode_video',
            'rules_desc',
            'visible_warnings_desc',
            'scoring_params_header_desc',
            'desktop_app_forbidden_processes',
            'desktop_app_allowed_processes',
            'desktop_app_forbidden_processes_desc',
